...
The plot above shows that only 33% of the gals that took the vaccine did in fact get covid-19, while 67% of the people taking the placebo contracted covid-19.  A substantially higher percentage of people who took tha vaccine contracted covid-19 versus those who were only given the placebo. The vaccine appears to be effective in protection against covid-19 for the gals (females). The odds of getting covid-19 while taking the vaccine is 1:3. The women that took the drug were half as likely to get covid-19 than those taking the placebo.
...
galsfish
```
The information to play close attention to among all of these results is the output of the Fisher's Exact test. The p-value displayed above is extremely small at 4e-16. This is an awfully small number. seeing this number means that these results are not likely to occur by chance.



The null hypothesis predicted that the deaths related to covid-19 are independent of sex. Since it is clear that sex does play a role in the death rate of individuals, the alternative hypothesis, that there is a correlation between covid-19 deaths and sex, is the favorable option.

The odd ratio above illustrates a ratio of 2.00. the gals(females) who received the vaccine were 1.5 times more likely to get covid-19 than those who received the placebo. 

```{r}
effect <- galsfish$p.value/(galsfish$p.value +1)
effectivenessguy = galsfish$estimate/(galsfish$estimate +1)*100
...
The plot above shows that only 33% of the drug users that took the vaccine did in fact get covid-19, while 67% of the people taking the placebo contracted covid-19.  A substantially higher percentage of people who took tha vaccine contracted covid-19 versus those who were only given the placebo. The vaccine appears to be effective in protection against covid-19 for the gals (females). The odds of getting covid-19 while taking the vaccine is 1:3. The drug users that took the drug were half as likely to get covid-19 than those taking the placebo.
...
In the second plot, the one above, The left two bars of the graph are all the gals that got covid-19. The x-axis represents whether a person got covid-19 or not. The y-axis, however, instead of representing the number of drug users who got covid-19, now represents the percentage of drug users that got covid-19 after taking the the placebo or taking the Vaccine. 
